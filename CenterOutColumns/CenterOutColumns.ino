...
// 0   1   2    3
//0 1 2 3 4 5 6 7 8
void ColumnOn (uint8_t columnNumber) {
  uint8_t columnOddNumber = columnNumber - 1;
  for (uint8_t boardNum=0; boardNum < 13; boardNum++) {
    if (columnNumber%2 == 0) {
      if (columnNumber/2 == boardNum) {
   ...
   else if (columnOddNumber/2 == boardNum) {
